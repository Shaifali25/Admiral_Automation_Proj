...
public class WindowsTest extends HelperFuc{
    ...
    static String USERNAME = "ShaifaliJain_OlIiQz";
    ...
    {
        try {
            driver = new RemoteWebDriver(new URL(URL), (Capabilities) setWindowscap());
   ...
   @Test(priority=18)
    ...
    public static void WorkDetMsg() throws IOException {
            try{
                driver.findElement(By.id("Save_TimeSheet")).click();
                String msg9= driver.findElement(By.xpath("//span[@data-valmsg-for='WorkDetail']")).getText();
    ...
    public static void ManageWFHDet() throws IOException {
        try {
            ...
            Thread.sleep(5000);
            driver.findElement(By.linkText("WFH Information")).click();
